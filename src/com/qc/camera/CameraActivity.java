...
public class CameraActivity extends Activity {
		...
		public void onClick(View v) {
			...
			.setPositiveButton("拍照上传",
					...
					.setNegativeButton("相册选择",
							new ButtonChoosePhotoClicker(this.whichphoto)
							);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		Toast.makeText(this, "on activity result is called", Toast.LENGTH_SHORT)
		.show();
		switch (requestCode) {
		case CAPTURE_FIRST_IMAGE_ACTIVITY_REQUEST_CODE:
			if (resultCode == RESULT_OK) {
				...
				Toast.makeText(this, "Picture was not taken: else",
						Toast.LENGTH_SHORT).show();
			}
			break;
